...
module.exports = grammar({
  ...
  rules: {
    ...
    non_expr_macro_ref: $ => choice($.stmt_list_macro_ref, $.cte_tables_macro_ref, $.select_core_macro_ref, $.select_expr_macro_ref, $.query_parts_macro_ref),
    macro_ref: $ => prec.left(1, choice(seq($.ID, '!'), seq($.ID, '!', '(', optional($.opt_macro_args), ')'), seq($.basic_expr, ':', $.ID, '!', '(', optional($.opt_macro_args), ')'), seq($.basic_expr, ':', $.ID, '!'))),
    expr_macro_ref: $ => prec(100, $.macro_ref),
    query_parts_macro_ref: $ => prec(2, $.macro_ref),
    cte_tables_macro_ref: $ => prec(3, $.macro_ref),
    select_core_macro_ref: $ => prec(4, $.macro_ref),
    select_expr_macro_ref: $ =>  prec(5,  $.macro_ref),
    stmt_list_macro_ref: $ => prec(6, $.macro_ref),
    stmt_list: $ => repeat1(choice(seq($.stmt, ';'), $.include_stmt, $.comment, $.line_directive, $.macro)),
    ...
    set_stmt: $ => choice(seq($.SET, $.sql_name, ":=", $.expr), seq($.SET, $.sql_name, $.FROM, $.CURSOR, $.name), seq($.SET, $.sql_name, '[', optional($.arg_list), ']', ":=", $.expr)),
    ...
    drop_table_stmt: $ => choice(seq($.DROP, $.TABLE, $.IF, $.EXISTS, $.sql_name), seq($.DROP, $.TABLE, $.sql_name)),
    drop_view_stmt: $ => choice(seq($.DROP, $.VIEW, $.IF, $.EXISTS, $.sql_name), seq($.DROP, $.VIEW, $.sql_name)),
    drop_index_stmt: $ => choice(seq($.DROP, $.INDEX, $.IF, $.EXISTS, $.sql_name), seq($.DROP, $.INDEX, $.sql_name)),
    drop_trigger_stmt: $ => choice(seq($.DROP, $.TRIGGER, $.IF, $.EXISTS, $.sql_name), seq($.DROP, $.TRIGGER, $.sql_name)),
    ...
    shape_expr: $ => choice($.sql_name, seq('-', $.sql_name)),
    shape_def: $ => choice($.shape_def_base, seq($.shape_def_base, '(', $.shape_exprs, ')')),
    shape_def_base: $ => choice(seq($.LIKE, $.sql_name), seq($.LIKE, $.name, $.ARGUMENTS)),
    QID: $ => prec.left(1, seq(CI('`quoted'), CI('identifier`'))),
    sql_name: $ => choice($.name, $.QID),
    ...
    misc_attr_value: $ => choice($.sql_name, $.any_literal, $.const_expr, seq('(', $.misc_attr_value_list, ')'), seq('-', $.num_literal), seq('+', $.num_literal)),
    ...
    pk_def: $ => choice(seq($.CONSTRAINT, $.sql_name, $.PRIMARY, $.KEY, '(', $.indexed_columns, ')', optional($.opt_conflict_clause)), seq($.PRIMARY, $.KEY, '(', $.indexed_columns, ')', optional($.opt_conflict_clause))),
    ...
    fk_def: $ => choice(seq($.CONSTRAINT, $.sql_name, $.FOREIGN, $.KEY, '(', $.sql_name_list, ')', $.fk_target_options), seq($.FOREIGN, $.KEY, '(', $.sql_name_list, ')', $.fk_target_options)),
    fk_target_options: $ => prec.left(seq($.REFERENCES, $.sql_name, '(', $.sql_name_list, ')', optional($.opt_fk_options))),
    unq_def: $ => choice(seq($.CONSTRAINT, $.sql_name, $.UNIQUE, '(', $.indexed_columns, ')', optional($.opt_conflict_clause)), seq($.UNIQUE, '(', $.indexed_columns, ')', optional($.opt_conflict_clause))),
    opt_unique: $ => $.UNIQUE,
    ...
    name: $ => choice($.ID, $.TEXT, $.TRIGGER, $.ROWID, $.REPLACE, $.KEY, $.VIRTUAL, $.TYPE, $.HIDDEN, $.PRIVATE, $.FIRST, $.LAST, $.ADD, $.AFTER, $.BEFORE, $.VIEW, $.INDEX, $.COLUMN, $.EXPR, $.STMT_LIST, $.QUERY_PARTS, $.CTE_TABLES, $.SELECT_CORE, $.SELECT_EXPR, seq($.AT_ID, '(', $.text_args, ')')),
    loose_name: $ => prec.left(100, choice($.name, $.CALL, $.SET, $.BOOL, $.INT, $.LONG, $.REAL, $.BLOB, $.OBJECT, $.RIGHT, $.LEFT)),
    loose_name_or_type: $ => choice($.loose_name, $.ALL, seq($.loose_name, '<', $.loose_name, '>')),
    opt_sql_name: $ => $.sql_name,
    name_list: $ => choice($.name, seq($.name, ',', $.name_list)),
    sql_name_list: $ => choice($.sql_name, seq($.sql_name, ',', $.sql_name_list)),
    opt_name_list: $ => $.name_list,
    opt_sql_name_list: $ => $.sql_name_list,
    ...
    data_type_any: $ => choice($.data_type_numeric, seq($.TEXT, optional($.opt_kind)), seq($.BLOB, optional($.opt_kind)), seq($.OBJECT, optional($.opt_kind)), seq($.OBJECT, '<', $.name, $.CURSOR, '>'), seq($.OBJECT, '<', $.name, $.SET, '>'), $.ID, seq($.AT_ID, '(', $.text_args, ')')),
    ...
    any_literal: $ => choice($.str_literal, $.num_literal, $.NULL, seq($.AT_FILE, '(', $.str_literal, ')'), $.AT_LINE, $.AT_MACRO_LINE, $.AT_MACRO_FILE, $.AT_PROC, seq($.AT_TEXT, '(', $.text_args, ')'), $.BLOB_LIT),
    text_args: $ => choice($.text_arg, seq($.text_arg, ',', $.text_args)),
    text_arg: $ => choice($.expr, $.non_expr_macro_ref),
    raise_expr: $ => choice(seq($.RAISE, '(', $.IGNORE, ')'), seq($.RAISE, '(', $.ROLLBACK, ',', $.expr, ')'), seq($.RAISE, '(', $.ABORT, ',', $.expr, ')'), seq($.RAISE, '(', $.FAIL, ',', $.expr, ')')),
    simple_call: $ => choice(seq($.loose_name, '(', optional($.DISTINCT), optional($.arg_list), ')', optional($.opt_filter_clause)), seq($.GLOB, '(', optional($.DISTINCT), optional($.arg_list), ')', optional($.opt_filter_clause)), seq($.LIKE, '(', optional($.DISTINCT), optional($.arg_list), ')', optional($.opt_filter_clause))),
    call: $ => choice($.simple_call, seq($.basic_expr, ':', $.simple_call), seq($.basic_expr, ':', $.loose_name), seq($.basic_expr, ':', '(', optional($.arg_list), ')')),
    basic_expr: $ => prec.left(1,  choice(
      ...
      seq($.basic_expr, '.', '*'), 
      $.any_literal, $.const_expr,
      seq('(', $.expr, ')'), $.call, 
      $.window_func_inv, $.raise_expr, 
      seq('(', $.select_stmt, ')'), 
    ...
    math_expr: $ => prec.left(choice($.basic_expr, seq($.math_expr, '&', $.math_expr), seq($.math_expr, '|', $.math_expr), seq($.math_expr, "<<", $.math_expr), seq($.math_expr, ">>", $.math_expr), seq($.math_expr, '+', $.math_expr), seq($.math_expr, '-', $.math_expr), seq($.math_expr, '*', $.math_expr), seq($.math_expr, '/', $.math_expr), seq($.math_expr, '%', $.math_expr), seq($.math_expr, $.IS_NOT_TRUE), seq($.math_expr, $.IS_NOT_FALSE), seq($.math_expr, $.ISNULL), seq($.math_expr, $.NOTNULL), seq($.math_expr, $.IS_TRUE), seq($.math_expr, $.IS_FALSE), seq('-', $.math_expr), seq('+', $.math_expr), seq('~', $.math_expr), seq($.NOT, $.math_expr), seq($.math_expr, '=', $.math_expr), seq($.math_expr, "==", $.math_expr), seq($.math_expr, '<', $.math_expr), seq($.math_expr, '>', $.math_expr), seq($.math_expr, "<>", $.math_expr), seq($.math_expr, "!=", $.math_expr), seq($.math_expr, ">=", $.math_expr), seq($.math_expr, "<=", $.math_expr), seq($.math_expr, $.NOT_IN, '(', optional($.opt_expr_list), ')'), seq($.math_expr, $.NOT_IN, '(', $.select_stmt, ')'), seq($.math_expr, $.IN, '(', optional($.opt_expr_list), ')'), seq($.math_expr, $.IN, '(', $.select_stmt, ')'), seq($.math_expr, $.LIKE, $.math_expr), seq($.math_expr, $.NOT_LIKE, $.math_expr), seq($.math_expr, $.MATCH, $.math_expr), seq($.math_expr, $.NOT_MATCH, $.math_expr), seq($.math_expr, $.REGEXP, $.math_expr), seq($.math_expr, $.NOT_REGEXP, $.math_expr), seq($.math_expr, $.GLOB, $.math_expr), seq($.math_expr, $.NOT_GLOB, $.math_expr), seq($.math_expr, $.BETWEEN, $.math_expr, $.AND, $.math_expr), seq($.math_expr, $.NOT_BETWEEN, $.math_expr, $.AND, $.math_expr), seq($.math_expr, $.IS_NOT, $.math_expr), seq($.math_expr, $.IS, $.math_expr), seq($.math_expr, "||", $.math_expr), seq($.math_expr, $.COLLATE, $.name))),
    ...
    cte_decl: $ => prec.left(1, choice(seq($.name, '(', $.name_list, ')'), seq($.name, '(', '*', ')'), $.name)),
    shared_cte: $ => choice($.call_stmt, seq($.call_stmt, $.USING, $.cte_binding_list)),
    cte_table: $ => choice(seq($.cte_decl, $.AS, '(', $.select_stmt, ')'), seq($.cte_decl, $.AS, '(', $.shared_cte, ')'), seq('(', $.call_stmt, ')'), seq('(', $.call_stmt, $.USING, $.cte_binding_list, ')'), seq($.cte_decl, $.LIKE, '(', $.select_stmt, ')'), seq($.cte_decl, $.LIKE, $.sql_name), $.cte_tables_macro_ref),
    ...
    select_core_list: $ => choice($.select_core, seq($.select_core, $.compound_operator, $.select_core_list), $.select_core_macro_ref, seq($.select_core_macro_ref, $.compound_operator, $.select_core_list)),
    ...
    select_expr_list: $ => choice($.select_expr, seq($.select_expr, ',', $.select_expr_list), $.select_expr_macro_ref, seq($.select_expr_macro_ref, ',', $.select_expr_list)),
    select_expr: $ => choice(seq($.expr, optional($.opt_as_alias)), $.column_calculation),
    opt_as_alias: $ => $.as_alias,
    as_alias: $ => choice(seq($.AS, $.sql_name), $.sql_name),
    ...
    table_or_subquery: $ => choice(seq($.sql_name, optional($.opt_as_alias)), seq('(', $.select_stmt, ')', optional($.opt_as_alias)), seq('(', $.shared_cte, ')', optional($.opt_as_alias)), seq($.table_function, optional($.opt_as_alias)), seq('(', $.query_parts, ')'), seq($.query_parts_macro_ref, optional($.opt_as_alias))),
    ...
    create_view_stmt: $ => choice(seq($.CREATE, optional($.opt_temp), $.VIEW, optional($.opt_if_not_exists), $.sql_name, $.AS, $.select_stmt, optional($.opt_delete_version_attr)), seq($.CREATE, optional($.opt_temp), $.VIEW, optional($.opt_if_not_exists), $.sql_name, '(', $.name_list, ')', $.AS, $.select_stmt, optional($.opt_delete_version_attr))),
    ...
    opt_column_spec: $ => choice(seq('(', optional($.opt_sql_name_list), ')'), seq('(', $.shape_def, ')')),
    column_spec: $ => choice(seq('(', $.sql_name_list, ')'), seq('(', $.shape_def, ')')),
    ...
    insert_stmt: $ => choice(seq($.insert_stmt_type, $.sql_name, optional($.opt_column_spec), $.select_stmt, optional($.opt_insert_dummy_spec)), seq($.insert_stmt_type, $.sql_name, optional($.opt_column_spec), $.from_shape, optional($.opt_insert_dummy_spec)), seq($.insert_stmt_type, $.sql_name, $.DEFAULT, $.VALUES), seq($.insert_stmt_type, $.sql_name, $.USING, $.select_stmt), seq($.insert_stmt_type, $.sql_name, $.USING, $.expr_names, optional($.opt_insert_dummy_spec))),
    ...
    basic_update_stmt: $ => seq($.UPDATE, optional($.opt_sql_name), $.SET, $.update_list, optional($.opt_from_query_parts), optional($.opt_where)),
    with_update_stmt: $ => seq($.with_prefix, $.update_stmt),
    update_stmt: $ => choice(seq($.UPDATE, $.sql_name, $.SET, $.update_list, optional($.opt_from_query_parts), optional($.opt_where), optional($.opt_orderby), optional($.opt_limit)), seq($.UPDATE, $.sql_name, $.SET, $.column_spec, '=', '(', optional($.insert_list), ')', optional($.opt_from_query_parts), optional($.opt_where), optional($.opt_orderby), optional($.opt_limit))),
    ...
    declare_func_stmt: $ => choice(seq($.DECLARE, $.function, $.loose_name, '(', optional($.func_params), ')', $.data_type_with_options), seq($.DECLARE, $.function, $.loose_name, '(', optional($.func_params), ')', $.CREATE, $.data_type_with_options), seq($.DECLARE, $.function, $.loose_name, $.NO, $.CHECK, $.data_type_with_options), seq($.DECLARE, $.function, $.loose_name, $.NO, $.CHECK, $.CREATE, $.data_type_with_options)),
    procedure: $ => choice($.PROC, $.PROCEDURE),
    declare_proc_no_check_stmt: $ => seq($.DECLARE, $.procedure, $.loose_name, $.NO, $.CHECK),
    declare_proc_stmt: $ => choice(seq($.DECLARE, $.procedure, $.loose_name, '(', optional($.params), ')'), seq($.DECLARE, $.procedure, $.loose_name, '(', optional($.params), ')', '(', $.typed_names, ')'), seq($.DECLARE, $.procedure, $.loose_name, '(', optional($.params), ')', $.USING, $.TRANSACTION), seq($.DECLARE, $.procedure, $.loose_name, '(', optional($.params), ')', $.OUT, '(', $.typed_names, ')'), seq($.DECLARE, $.procedure, $.loose_name, '(', optional($.params), ')', $.OUT, '(', $.typed_names, ')', $.USING, $.TRANSACTION), seq($.DECLARE, $.procedure, $.loose_name, '(', optional($.params), ')', $.OUT, $.UNION, '(', $.typed_names, ')'), seq($.DECLARE, $.procedure, $.loose_name, '(', optional($.params), ')', $.OUT, $.UNION, '(', $.typed_names, ')', $.USING, $.TRANSACTION)),
    declare_interface_stmt: $ => choice(seq($.DECLARE, $.INTERFACE, $.name, '(', $.typed_names, ')'), seq($.INTERFACE, $.name, '(', $.typed_names, ')')),
    create_proc_stmt: $ => choice(seq($.CREATE, $.procedure, $.loose_name, '(', optional($.params), ')', $.BEGIN, $.opt_stmt_list, $.END), seq($.procedure, $.loose_name, '(', optional($.params), ')', $.BEGIN, $.opt_stmt_list, $.END)),
    inout: $ => choice($.IN, $.OUT, $.INOUT),
    typed_name: $ => choice(seq($.sql_name, $.data_type_with_options), $.shape_def, seq($.name, $.shape_def)),
    ...
    param: $ => choice(seq($.sql_name, $.data_type_with_options), seq($.inout, $.sql_name, $.data_type_with_options), $.shape_def, seq($.name, $.shape_def)),
    ...
    declare_vars_stmt: $ => choice(seq($.DECLARE, $.sql_name_list, $.data_type_with_options), seq($.VAR, $.name_list, $.data_type_with_options), $.declare_value_cursor),
    ...
    throw_stmt: $ => $.THROW,
    trycatch_stmt: $ => choice(seq($.BEGIN, $.TRY, optional($.opt_stmt_list), $.END, $.TRY, ';', $.BEGIN, $.CATCH, optional($.opt_stmt_list), $.END, $.CATCH), seq($.TRY, optional($.opt_stmt_list), $.CATCH, optional($.opt_stmt_list), $.END)),
    ...
    echo_stmt: $ => choice(seq($.AT_ECHO, $.name, ',', $.str_literal), seq($.AT_ECHO, $.name, ',', $.AT_TEXT, '(', $.text_args, ')')),
    ...
    expr_macro_def: $ => seq($.AT_MACRO, '(', $.EXPR, ')', $.name, '!', '(', optional($.opt_macro_formals), ')'),
    stmt_list_macro_def: $ => seq($.AT_MACRO, '(', $.STMT_LIST, ')', $.name, '!', '(', optional($.opt_macro_formals), ')'),
    query_parts_macro_def: $ => seq($.AT_MACRO, '(', $.QUERY_PARTS, ')', $.name, '!', '(', optional($.opt_macro_formals), ')'),
    cte_tables_macro_def: $ => seq($.AT_MACRO, '(', $.CTE_TABLES, ')', $.name, '!', '(', optional($.opt_macro_formals), ')'),
    select_core_macro_def: $ => seq($.AT_MACRO, '(', $.SELECT_CORE, ')', $.name, '!', '(', optional($.opt_macro_formals), ')'),
    select_expr_macro_def: $ => seq($.AT_MACRO, '(', $.SELECT_EXPR, ')', $.name, '!', '(', optional($.opt_macro_formals), ')'),
    op_stmt: $ => choice(seq($.AT_OP, $.data_type_any, ':', $.loose_name, $.loose_name_or_type, $.AS, $.loose_name), seq($.AT_OP, $.CURSOR, ':', $.loose_name, $.loose_name_or_type, $.AS, $.loose_name), seq($.AT_OP, $.NULL, ':', $.loose_name, $.loose_name_or_type, $.AS, $.loose_name)),
    macro_def_stmt: $ => choice(seq($.expr_macro_def, $.BEGIN, $.expr, $.END), seq($.stmt_list_macro_def, $.BEGIN, $.stmt_list, $.END), seq($.query_parts_macro_def, $.BEGIN, $.query_parts, $.END), seq($.cte_tables_macro_def, $.BEGIN, $.cte_tables, $.END), seq($.select_core_macro_def, $.BEGIN, $.select_core_list, $.END), seq($.select_expr_macro_def, $.BEGIN, $.select_expr_list, $.END)),
    opt_macro_args: $ => $.macro_args,
    macro_arg: $ => choice($.expr, seq($.BEGIN, $.stmt_list, $.END), $.stmt_list_macro_ref, seq($.FROM, '(', $.query_parts, ')'), $.query_parts_macro_ref, seq($.WITH, '(', $.cte_tables, ')'), $.cte_tables_macro_ref, seq($.ALL, '(', $.select_core_list, ')'), $.select_core_macro_ref, seq($.SELECT, '(', $.select_expr_list, ')'), $.select_expr_macro_ref),
    macro_args: $ => choice($.macro_arg, seq($.macro_arg, ',', $.macro_args)),
    opt_macro_formals: $ => $.macro_formals,
    macro_formals: $ => choice($.macro_formal, seq($.macro_formal, ',', $.macro_formals)),
    macro_formal: $ => seq($.name, '!', $.macro_type),
    macro_type: $ => choice($.EXPR, $.STMT_LIST, $.QUERY_PARTS, $.CTE_TABLES, $.SELECT_CORE, $.SELECT_EXPR),
