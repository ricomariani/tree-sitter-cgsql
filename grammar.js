...
module.exports = grammar({
  ...
  rules: {
    ...
    expr_macro_ref: $ => prec.left(1,choice(seq($.ID_BANG), seq($.ID_BANG, '(', $.opt_macro_args, ')'), seq($.basic_expr, ':', $.ID_BANG, '(', optional($.opt_macro_args), ')'), seq($.basic_expr, ':', $.ID_BANG))),
    ...
    create_proc_stmt: $ => choice(seq($.CREATE, $.procedure, $.loose_name, '(', optional($.params), ')', $.BEGIN, optional($.stmt_list), $.END), seq($.procedure, $.loose_name, '(', optional($.params), ')', $.BEGIN, optional($.stmt_list), $.END)),
    ...
    throw_stmt: $ => $.THROW,
    trycatch_stmt: $ => choice(seq($.BEGIN, $.TRY, optional($.stmt_list), $.END, $.TRY, ';', $.BEGIN, $.CATCH, optional($.stmt_list), $.END, $.CATCH), seq($.TRY, optional($.stmt_list), $.CATCH, optional($.stmt_list), $.END)),
    ...
    if_stmt: $ => seq($.IF, $.expr, $.THEN, optional($.stmt_list), optional(repeat1($.elseif_item)), optional($.opt_else), $.END, optional($.IF)),
